...
//         {positions.map((positionPair, pageIndex) => (
//           <div 
//             key={pageIndex} 
//             className={`${pageIndex === activeIndex ? 'block' : 'hidden'}`}
//           >
//             <div className="grid grid-cols-1 md:grid-cols-2">
//               {positionPair.map((position, index) => (
...
//       <div className="flex justify-center items-center space-x-2 mt-6 md:mt-0">
