...
//   return (
//     <div className="flex md:ml-5 md:mt-13 lg:mt-0 lg:ml-10 md:flex-col items-center justify-center bg-transparent w-full md:w-[60px]">
          ...
          >
            <button
              ...
              className={`w-full text-left p-3 dark:text-white bg-gray-200 dark:bg-[#1C1C1C] rounded-full ${
                activeTab === "about" ? "text-pink-500" : "hover:text-pink-600"
              }`}
            >
              <IoPerson className="text-[25px]" />
            </button>
        ...
        <li>
          ...
          >
            <button
              onClick={() => setActiveTab("resume")}
              className={`w-full text-left p-3 dark:text-white bg-gray-200 dark:bg-[#1C1C1C] rounded-full ${
                activeTab === "resume" ? "text-pink-500" : "hover:text-pink-600"
              }`}
            >
              <CgLoadbarDoc className="text-[25px]" />
            </button>
        ...
        <li>
          ...
          >
            <button
              onClick={() => setActiveTab("projects")}
              className={`w-full text-left p-3 dark:text-white bg-gray-200 dark:bg-[#1C1C1C] rounded-full ${
                activeTab === "projects" ? "text-pink-500" : "hover:text-pink-600"
              }`}
            >
              <FaToolbox className="text-[25px]" />
            </button>
        ...
        <li>
          ...
          >
            <button
              onClick={() => setActiveTab("contact")}
              className={`w-full text-left p-3 dark:text-white bg-gray-200 dark:bg-[#1C1C1C] rounded-full ${
                activeTab === "contact" ? "text-pink-500" : "hover:text-pink-600"
              }`}
            >
              <FaPaperPlane className="text-[25px]" />
            </button>
