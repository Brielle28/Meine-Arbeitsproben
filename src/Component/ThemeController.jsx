    ...
    <>
      <div>
        <label className="swap swap-rotate">
          ...
          <svg
            className="swap-on h-[28px] w-[28px] fill-current hover:text-pink-600"
          ...
          <svg
            className="swap-off h-[28px] w-[28px] fill-current hover:text-pink-600"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
        ...
        {/* Optional: Add a button to reset to system preference */}
        {/* <button 
          onClick={useSystemPreference}
          className="ml-2 text-xs hover:text-pink-600"
        >
          Auto
        </button> */}
      </div>
